# This Makefile is for the Ez::Println extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Println.pm]
#     AUTHOR => [q[Alexej G. Magura <agm2819@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Ez::Println]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Println.pm]
...
TO_INST_PM = lib/Println.pm

PM_TO_BLIB = lib/Println.pm \
	blib/lib/Println.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Ez-Println' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires: {}' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: v0.1.3.2' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Ez-Println",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "v0.1.3.2"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Println.pm blib/lib/Println.pm 
